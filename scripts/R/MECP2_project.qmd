...
1.  Figure 1A.
    ...
    load('/archive/OBI/Neuroinformatics_Core/Stroud_lab/shared//8wk_CTX_Stroud2017_mm10_BSmap_CA.RData',verbose = TRUE)

    # Read mean coverage of MECP2 7wk_MECP2 sample
    MECP2_7wk_cov = read.csv("/archive/OBI/Neuroinformatics_Core/Stroud_lab/shared//7wk_CTX_MECP2_gene_Cov.bed",sep = "\t",header = F)
    ...
    IgG_7wk_cov = read.csv("/archive/OBI/Neuroinformatics_Core/Stroud_lab/shared//7wk_CTX_IgG_gene_Cov.bed",sep = "\t",header = F)
